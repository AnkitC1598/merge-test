				...
				{fetchingUpcoming ? (
					...
					<div className="flex flex-col rounded-md">
						...
						<div className="@container/session p-4">
							<div className="gap-4 grid grid-flow-col @5xl:auto-cols-[calc(25%_-_32px)] @4xl:auto-cols-[calc(25%_-_32px)] @xl:auto-cols-[calc(33%_-_32px)] @sm:auto-cols-[calc(52%_-_32px)] auto-cols-[calc(78%_-_32px)] overflow-x-scroll overflow-y-visible scrollbar-hide">
								<Sessions
									makeRoute
									sessions={upcoming}
								/>
