...
const types = [
	...
	},
	{
		...
		colors: {
			options: {
				active: "text-pink-700 dark:text-pink-200 bg-purple-100 dark:bg-purple-500",
				base: "text-pink-700 dark:text-pink-400",
				iconActive: "text-pink-400 dark:text-pink-200",
				iconBase: "text-pink-400",
			},
			form: {
			...
			bgText: "bg-pink-50 dark:bg-pink-400/10 text-pink-700 dark:text-pink-400 ring-pink-700/10 dark:ring-pink-400/30",
			icon: "text-pink-200 dark:text-pink-400",
			border: "border-pink-200 dark:border-pink-600",
			blob: "bg-[radial-gradient(ellipse_100%_100%_at_bottom_left,rgba(219,_39,_119,_0.15)_0%,rgba(76,_182,_193,_0)_100%)] dark:bg-[radial-gradient(ellipse_100%_100%_at_bottom_left,rgba(244,_114,_182,_0.15)_0%,rgba(76,_182,_193,_0)_100%)]",
		},
		type: "content",
